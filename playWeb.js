...
(function() {
  var BasicAI, PlayerState, State, action, applyBenefit, arrayEqual, attack, basicCard, c, cloneDominionObject, compileStrategies, countInList, countStr, duration, makeCard, makeStrategy, modifyCoreTypes, noColony, nullUpgradeChoices, numericSort, playGame, prize, ref, restoreCoreTypes, shuffle, spyDecision, stringify, transferCard, transferCardToTop, treasure, upgradeChoices, useCoreTypeMods,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    hasProp = {}.hasOwnProperty;

  compileStrategies = function(scripts, errorHandler) {
    var e, i, l, ref, ref1, strategies, strategy, usedNames;
    strategies = [];
    usedNames = [];
    for (i = l = 0, ref = scripts.length; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
      try {
        strategy = CoffeeScript["eval"](scripts[i], {
          bare: true
        });
        while (ref1 = strategy.name, indexOf.call(usedNames, ref1) >= 0) {
          strategy.name += "Clone";
        }
  ...
  playGame = function(strategies, options, ret) {
    var ai, ais, err, errorHandler, item, ref, state;
    ais = (function() {
      var l, len, results;
      results = [];
      for (l = 0, len = strategies.length; l < len; l++) {
        item = strategies[l];
        results.push(makeStrategy(item));
      }
      return results;
    })();
    options.tracker.setPlayers((function() {
      var l, len, results;
      results = [];
      for (l = 0, len = ais.length; l < len; l++) {
        ai = ais[l];
        results.push(ai.name);
      }
      return results;
    })());
    ...
    while (!state.gameIsOver()) {
      try {
        ...
        err = error;
        errorHandler = (ref = options.errorHandler) != null ? ref : typeof alert !== "undefined" && alert !== null ? alert : console.log;
  ...
  BasicAI = (function() {
    function BasicAI() {
      ...
      this.herbalistValue = bind(this.herbalistValue, this);
      this.trashOppTreasureValue = bind(this.trashOppTreasureValue, this);
      this.putOnDeckValue = bind(this.putOnDeckValue, this);
    }
    ...
    BasicAI.prototype.choose = function(type, state, choices) {
      var bestChoice, bestValue, choice, choiceSet, l, len, len1, len2, my, n, nullable, o, preference, priority, priorityfunc, value;
      ...
      if (priorityfunc != null) {
        choiceSet = {};
        for (l = 0, len = choices.length; l < len; l++) {
          choice = choices[l];
          choiceSet[choice] = choice;
        }
        nullable = indexOf.call(choices, null) >= 0;
        priority = priorityfunc.call(this, state, my);
        for (n = 0, len1 = priority.length; n < len1; n++) {
          preference = priority[n];
      ...
      bestChoice = null;
      bestValue = -2e308;
      for (o = 0, len2 = choices.length; o < len2; o++) {
        choice = choices[o];
      ...
      if (indexOf.call(choices, bestChoice) >= 0) {
        return bestChoice;
      }
      if (indexOf.call(choices, null) >= 0) {
        return null;
      }
    ...
    BasicAI.prototype.getScoreDifference = function(state, my) {
      var l, len, myScore, name, opponentScore, ref, score, status, turns;
      ref = state.getFinalStatus();
      for (l = 0, len = ref.length; l < len; l++) {
        status = ref[l];
    ...
    BasicAI.prototype.countNotInHand = function(my, card) {
      return my.countInDeck(card) - my.countInHand(card);
    };

    BasicAI.prototype.countInDraw = function(my, card) {
    ...
    BasicAI.prototype.gainPriority = function(state, my) {
      var ref, ref1;
      return [my.countInDeck("Platinum") > 0 ? "Colony" : void 0, state.countInSupply("Colony") <= 6 ? "Province" : void 0, (0 < (ref = state.gainsToEndGame()) && ref <= 5) ? "Duchy" : void 0, (0 < (ref1 = state.gainsToEndGame()) && ref1 <= 2) ? "Estate" : void 0, "Platinum", "Gold", "Silver", state.gainsToEndGame() <= 3 ? "Copper" : void 0];
    };
    ...
    BasicAI.prototype.old_actionPriority = function(state, my, skipMultipliers) {
      var card, choice, choice1, choices, countInHandCopper, currentAction, mult, multiplier, mults, okayToPlayMultiplier, ref, ref1, ref2, wantsToPlayMultiplier, wantsToTrash;
    ...
    BasicAI.prototype.treasurePriority = function(state, my) {
      return ["Platinum", "Diadem", "Philosopher's Stone", "Gold", "Cache", "Hoard", "Royal Seal", "Harem", "Silver", "Fool's Gold", "Quarry", "Talisman", "Copper", "Masterpiece", "Potion", "Loan", "Venture", "Ill-Gotten Gains", "Bank", my.numUniqueCardsInPlay() >= 2 ? "Horn of Plenty" : void 0, this.wantsToPlaySpoils(state) ? "Spoils" : void 0, null];
    };
    ...
    BasicAI.prototype.putOnDeckPriority = function(state, my) {
      var actions, byPlayValue, card, getChoiceValue, l, len, len1, margin, n, putBack, ref, treasures;
      actions = (function() {
        var l, len, ref, results;
        ref = my.hand;
        results = [];
      ...
      if (putBack.length === 0) {
        ...
        for (l = 0, len = ref.length; l < len; l++) {
          card = ref[l];
          if (card.isTreasure && (!(indexOf.call(treasures, card) >= 0))) {
            treasures.push(card);
          }
        }
        ...
        for (n = 0, len1 = treasures.length; n < len1; n++) {
          card = treasures[n];
        ...
        if (my.countInPlay(state.cardInfo["Alchemist"]) > 0) {
          if (indexOf.call(putBack, "Potion") >= 0) {
    ...
    BasicAI.prototype.reshuffleValue = function(state, choice, my) {
      var card, junkToDraw, l, len, len1, n, proportion, ref, ref1, totalJunk;
      junkToDraw = 0;
      totalJunk = 0;
      ref = my.draw;
      for (l = 0, len = ref.length; l < len; l++) {
    ...
    BasicAI.prototype.ambassadorPriority = function(state, my) {
      ...
      return ["[Curse, 2]", "[Curse, 1]", "[Curse, 0]", "[Ambassador, 2]", "[Estate, 2]", "[Estate, 1]", my.getTreasureInHand() < 3 && my.getTotalMoney() >= 5 ? "[Copper, 2]" : void 0, my.getTreasureInHand() >= 5 ? "[Copper, 2]" : void 0, my.getTreasureInHand() === 3 && my.getTotalMoney() >= 7 ? "[Copper, 2]" : void 0, my.getTreasureInHand() < 3 && my.getTotalMoney() >= 4 ? "[Copper, 1]" : void 0, my.getTreasureInHand() >= 4 ? "[Copper, 1]" : void 0, "[Estate, 0]", "[Copper, 0]", "[Potion, 2]", "[Potion, 1]", null].concat(((function() {
        var l, len, ref, results;
        ref = my.ai.trashPriority(state, my);
        results = [];
        for (l = 0, len = ref.length; l < len; l++) {
          card = ref[l];
          if (card != null) {
    ...
    BasicAI.prototype.apprenticeTrashValue = function(state, card, my) {
      var coins, drawn, potions, ref, vp;
      vp = card.getVP(my);
      ref = card.getCost(state), coins = ref[0], potions = ref[1];
    ...
    BasicAI.prototype.bishopTrashValue = function(state, card, my) {
      var coins, potions, ref, value;
      ref = card.getCost(state), coins = ref[0], potions = ref[1];
      value = Math.floor(coins / 2) - card.getVP(my);
      if (this.goingGreen(state) >= 3) {
        return value;
      } else {
        if (indexOf.call(this.trashPriority(state, my), card) >= 0) {
          value += 1;
        }
    ...
    BasicAI.prototype.huntingGroundsGainPriority = function(state, my) {
      return ["Duchy", "Estates"];
    };
    ...
    BasicAI.prototype.plazaDiscardPriority = function(state, my) {
      return ["Copper", null];
    };

    BasicAI.prototype.rogueGainValue = function(state, card, my) {
      var coins, potions, ref;
      ref = card.getCost(state), coins = ref[0], potions = ref[1];
      return coins;
    };

    BasicAI.prototype.rogueTrashValue = function(state, card, my) {
      var coins, potions, ref;
      ref = card.getCost(state), coins = ref[0], potions = ref[1];
      return coins;
    };
    ...
    BasicAI.prototype.salvagerTrashValue = function(state, card, my) {
      var buyState, coins, gained, hypothesis, hypothetically_my, potions, ref, ref1;
      ref = state.hypothetical(this), hypothesis = ref[0], hypothetically_my = ref[1];
      hypothetically_my.hand.remove(card);
      ref1 = card.getCost(hypothesis), coins = ref1[0], potions = ref1[1];
    ...
    BasicAI.prototype.developValue = function(state, choice, my) {
      var newCard1, newCard2, oldCard, ref;
      oldCard = choice[0], (ref = choice[1], newCard1 = ref[0], newCard2 = ref[1]);
      return my.ai.cardInDeckValue(state, newCard1, my) + my.ai.cardInDeckValue(state, newCard2, my) - my.ai.cardInDeckValue(state, oldCard, my);
    };
    ...
    BasicAI.prototype.chooseOverpayMasterpiece = function(state, maxAmount) {
      return maxAmount;
    };

    BasicAI.prototype.spendCoinTokens = function(state, my) {
      var cardBought, cardsBought, cardsBoughtOld, coinCost, ct, hypMy, hypState, potionCost, ref, ref1;
      cardsBoughtOld = [];
      ct = my.coinTokens;
      while (true) {
        ref = state.hypothetical(this), hypState = ref[0], hypMy = ref[1];
        hypMy.coins += ct;
        ...
        while (hypMy.buys > 0) {
          ...
          if (cardBought != null) {
            ref1 = cardBought.getCost(hypState), coinCost = ref1[0], potionCost = ref1[1];
        ...
        if ((ct < my.coinTokens) && !(arrayEqual(cardsBought, cardsBoughtOld))) {
          ct += 1;
          break;
        }
        if (ct === 0) {
    ...
    BasicAI.prototype.benefitValue = function(state, choice, my) {
      var actionBalance, usableActions, value;
      actionBalance = my.actionBalance();
      usableActions = Math.max(0, -actionBalance);
      value = 0;
      if (choice.cards) {
        value += this.benefitCardValue(state, my, choice.cards, actionBalance);
      }
      if (choice.coins) {
        value += this.benefitCoinValue(state, my, choice.coins);
      }
      if (choice.buys) {
        value += this.benefitBuyValue(state, my, choice.buys);
      }
      if (choice.trash) {
        value += this.benefitTrashValue(state, my, choice.trash);
      }
      if (choice.actions) {
        value += this.benefitActionValue(state, my, choice.actions, usableActions);
      }
      if (choice.horseEffect) {
        value += this.benefitHorseEffectValue(state, my);
      }
      if (choice.gainSilver) {
        value += this.benefitGainSilverValue(state, my);
      }
      return value;
    };

    BasicAI.prototype.benefitBuyValue = function(state, my, count) {
      return 1 * count;
    };

    BasicAI.prototype.benefitCardValue = function(state, my, count, actionBalance) {
      var value;
      value = 2;
      if (actionBalance >= 1) {
        value += actionBalance;
    ...
    BasicAI.prototype.benefitCoinValue = function(state, my, count) {
      return 3 * count;
    };

    BasicAI.prototype.benefitTrashValue = function(state, my, count) {
    ...
    BasicAI.prototype.benefitActionValue = function(state, my, count, usableActions) {
      return 10 * Math.min(count, usableActions);
    };

    BasicAI.prototype.benefitHorseEffectValue = function(state, my) {
      return 0;
    };

    BasicAI.prototype.benefitGainSilverValue = function(state, my) {
      return 3;
    };

    BasicAI.prototype.wantsToTrash = function(state) {
      var card, l, len, my, ref, trashableCards;
      my = this.myPlayer(state);
      trashableCards = 0;
      ref = my.hand;
      for (l = 0, len = ref.length; l < len; l++) {
    ...
    BasicAI.prototype.wantsToPlayRats = function(state) {
      return false;
    };

    BasicAI.prototype.wantsToDiscard = function(state) {
      var card, discardableCards, l, len, my, ref;
      my = this.myPlayer(state);
      discardableCards = 0;
      ref = my.hand;
      for (l = 0, len = ref.length; l < len; l++) {
    ...
    BasicAI.prototype.wantsToPlaySpoils = function(state) {
      var cardsGainedWith, cardsGainedWithout, hypMy, hypState, ref;
      if (state.depth > 0) {
        return true;
      } else {
    ...
    BasicAI.prototype.wantsToRebuild = function(state, my) {
      var answer;
      if (my.countInHand("Rebuild") >= state.countInSupply("Province") && my.ai.getScoreDifference(state, my) > 0) {
        answer = 1;
      } else if (state.countInSupply("Province") === 1 && my.ai.getScoreDifference(state, my) < -4) {
        answer = 0;
      } else if (state.countInSupply("Duchy") === 0 && my.ai.countNotInHand(my, "Duchy") === 0 && my.ai.getScoreDifference(state, my) < 0) {
        answer = 0;
      } else if (my.getTreasureInHand() > 7 && state.countInSupply("Province") === 1) {
        answer = 0;
      } else {
    ...
    BasicAI.prototype.rebuildPriority = function(state, my) {
      return ["Province", "Duchy", "Estate"];
    };

    BasicAI.prototype.nameVPPriority = function(state, my) {
      return [my.countInDeck("Colony") > 0 ? "Colony" : void 0, "Province"];
    };

    BasicAI.prototype.wantsToJM = function(state, my) {
      return true;
    };

    BasicAI.prototype.wantsToDiscardBeggar = function(state) {
      return true;
    };
    ...
    BasicAI.prototype.pessimisticBuyPhase = function(state) {
      var hypothesis, hypothetically_my, ref;
      if (state.depth > 0) {
    ...
    BasicAI.prototype.coinLossMargin = function(state) {
      var cardToBuy, coins, coinsCost, newState, potionsCost, ref;
      newState = this.pessimisticBuyPhase(state);
      ...
      ref = cardToBuy.getCost(newState), coinsCost = ref[0], potionsCost = ref[1];
      return coins - coinsCost;
    };

    BasicAI.prototype.coinGainMargin = function(state) {
      var baseCard, cardToBuy, coins, increment, l, len, newState, ref;
      newState = this.pessimisticBuyPhase(state);
      coins = newState.current.coins;
    ...
    BasicAI.prototype.coinsDueToCard = function(state, card) {
      var aCard, banks, nonbanks, value;
      c = state.cardInfo;
  ...
  basicCard = {
    ...
    getCost: function(state) {
      var coins, l, len, modifier, ref;
      coins = this.costInCoins(state);
      ref = state.costModifiers;
      for (l = 0, len = ref.length; l < len; l++) {
        modifier = ref[l];
    ...
    getCoinTokens: function(state) {
      return this.coinTokens;
    },
    ...
    onPlay: function(state) {
      var cardsToDraw, cardsToTrash, ct;
      ...
      if ((ct = this.getCoinTokens(state)) > 0) {
        state.log(state.current.ai + " gains " + ct + " Coin Token" + (ct > 1 ? "s" : ""));
      }
  ...
  makeCard('Copper', c.Silver, {
    ...
    getCoins: function(state) {
      var ref;
      return (ref = state.copperValue) != null ? ref : 1;
    },
    startingSupply: function(state) {
      return 60;
    }
  ...
  makeCard('Fairgrounds', c.Estate, {
    cost: 6,
    getVP: function(player) {
      var card, deck, l, len, unique;
      unique = [];
      deck = player.getDeck();
      for (l = 0, len = deck.length; l < len; l++) {
        card = deck[l];
        if (indexOf.call(unique, card) < 0) {
          unique.push(card);
        }
      }
  ...
  makeCard('Farmland', c.Estate, {
    ...
    upgradeFilter: function(state, oldCard, newCard) {
      var coins1, coins2, potions1, potions2, ref, ref1;
      ref = oldCard.getCost(state), coins1 = ref[0], potions1 = ref[1];
      ref1 = newCard.getCost(state), coins2 = ref1[0], potions2 = ref1[1];
  ...
  makeCard('Great Hall', c.Estate, {
    ...
    ai_playValue: function(state, my) {
      var ref;
      if (ref = c.Crossroads, indexOf.call(my.hand, ref) >= 0) {
        return 520;
      } else {
        return 742;
      }
  ...
  makeCard('Island', c.Estate, {
    ...
    startGameEffect: function(state) {
      ...
      for (l = 0, len = ref.length; l < len; l++) {
        player = ref[l];
        results.push(player.mats.island = []);
      }
      return results;
    },
    playEffect: function(state) {
      ...
      if (indexOf.call(state.current.inPlay, this) >= 0) {
  ...
  makeCard('Bank', treasure, {
    cost: 7,
    getCoins: function(state) {
      var card, coins, l, len, ref;
      coins = 0;
      ref = state.current.inPlay;
      for (l = 0, len = ref.length; l < len; l++) {
        card = ref[l];
        if (card.isTreasure) {
          coins += 1;
  ...
  makeCard("Horn of Plenty", treasure, {
    ...
    coins: 0,
    playEffect: function(state) {
      var card, cardName, choice, choices, coins, limit, potions, ref;
  ...
  makeCard('Ill-Gotten Gains', treasure, {
    ...
    gainEffect: function(state, player) {
      var i, l, ref, results;
      results = [];
      for (i = l = 0, ref = state.nPlayers; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
        if (state.players[i] !== player) {
          results.push(state.gainCard(state.players[i], c.Curse));
        } else {
          results.push(void 0);
        }
      }
  ...
  makeCard('Spoils', treasure, {
    ...
    playEffect: function(state) {
      ...
      return state.log(state.specialSupply['Spoils'] + " Spoils in the supply");
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Haven', duration, {
    ...
    startGameEffect: function(state) {
      ...
      for (l = 0, len = ref.length; l < len; l++) {
        player = ref[l];
        results.push(player.mats.haven = []);
      }
      return results;
    },
    playEffect: function(state) {
  ...
  makeCard('Develop', action, {
    ...
    playEffect: function(state) {
      var card, choice, choices, l, len, len1, len2, len3, len4, n, newCard, newCard1, newCard2, newCards, o, oldCard, oldChoices, p, partnerCard, partnerCards, q, ref, ref1, ref2;
      oldChoices = state.current.hand.unique();
      choices = [];
      for (l = 0, len = oldChoices.length; l < len; l++) {
        oldCard = oldChoices[l];
        newCards = [];
        ref = state.filledPiles();
        ...
        if (newCards.length === 0) {
          ...
          for (o = 0, len2 = newCards.length; o < len2; o++) {
            newCard = newCards[o];
            partnerCards = [];
            ref1 = state.filledPiles();
            ...
            if (partnerCards.length === 0) {
              ...
              for (q = 0, len4 = partnerCards.length; q < len4; q++) {
                partnerCard = partnerCards[q];
      ...
      if (choice !== null) {
        oldCard = choice[0], (ref2 = choice[1], newCard1 = ref2[0], newCard2 = ref2[1]);
        state.doTrash(state.current, oldCard);
        if (newCard1 !== null) {
  ...
  makeCard('Graverobber', c.Remodel, {
    ...
    playEffect: function(state) {
      var card, choice, choices, coins, l, len, newCard, oldCard, potions, ref, ref1;
      choices = upgradeChoices(state, state.current.hand, this.upgradeFilter.bind(this));
      ref = state.trash;
      for (l = 0, len = ref.length; l < len; l++) {
        card = ref[l];
        ref1 = card.getCost(state), coins = ref1[0], potions = ref1[1];
  ...
  makeCard('Remake', c.Remodel, {
    ...
    playEffect: function(state) {
      var choice, choices, choices2, i, l, newCard, oldCard, results;
      results = [];
      for (i = l = 1; l <= 2; i = ++l) {
        choices = upgradeChoices(state, state.current.hand, this.upgradeFilter.bind(this));
        choices2 = nullUpgradeChoices(state, state.current.hand, this.costFunction.bind(this));
        ...
        if (choice !== null) {
          ...
          state.doTrash(state.current, oldCard);
          if (newCard !== null) {
            results.push(state.gainCard(state.current, newCard));
          } else {
            results.push(void 0);
          }
        } else {
  ...
  makeCard('Ambassador', attack, {
    cost: 3,
    playEffect: function(state) {
      var card, cardName, choice, choices, count, counts, i, l, len, n, quantity, ref, ref1;
      counts = {};
      ref = state.current.hand;
      for (l = 0, len = ref.length; l < len; l++) {
        card = ref[l];
      ...
      if (choice !== null) {
        ...
        if (state.supply[card] != null) {
          for (i = n = 0, ref1 = quantity; 0 <= ref1 ? n < ref1 : n > ref1; i = 0 <= ref1 ? ++n : --n) {
            state.current.hand.remove(card);
          }
  ...
  makeCard('Bureaucrat', attack, {
    ...
    playEffect: function(state) {
      ...
      return state.attackOpponents(function(opp) {
        var card, choice, l, len, ref, victory;
        victory = [];
        ref = opp.hand;
        for (l = 0, len = ref.length; l < len; l++) {
          card = ref[l];
  ...
  makeCard('Cutpurse', attack, {
    ...
    playEffect: function(state) {
      return state.attackOpponents(function(opp) {
        var ref;
        if (ref = c.Copper, indexOf.call(opp.hand, ref) >= 0) {
  ...
  makeCard('Masterpiece', treasure, {
    ...
    coins: 1,
    buyEffect: function(state) {
      var amountOverpayed, i, l, ref, results;
      ...
      results = [];
      for (i = l = 1, ref = amountOverpayed; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
        results.push(state.gainCard(state.current, c['Silver'], 'discard', true));
      }
      return results;
    }
  });
  ...
  makeCard("Mountebank", attack, {
    ...
    playEffect: function(state) {
      return state.attackOpponents(function(opp) {
        var ref;
        if (ref = c.Curse, indexOf.call(opp.hand, ref) >= 0) {
  ...
  makeCard('Noble Brigand', attack, {
    ...
    coins: +1,
    buyEffect: function(state) {
      var l, len, opp, ref, results;
      ref = state.players.slice(1);
      results = [];
      for (l = 0, len = ref.length; l < len; l++) {
        opp = ref[l];
        results.push(c['Noble Brigand'].robTheRich(state, opp));
      }
      return results;
    },
    playEffect: function(state) {
    ...
    robTheRich: function(state, opp) {
      var card, drawn, gainCopper, l, len, silversAndGolds, treasureToTrash;
      drawn = opp.getCardsFromDeck(2);
      state.log("..." + opp.ai + " reveals " + drawn + ".");
      silversAndGolds = [];
      gainCopper = true;
      for (l = 0, len = drawn.length; l < len; l++) {
        card = drawn[l];
        if (card.isTreasure) {
          gainCopper = false;
  ...
  makeCard('Pirate Ship', attack, {
    ...
    startGameEffect: function(state) {
      ...
      for (l = 0, len = ref.length; l < len; l++) {
        player = ref[l];
        results.push(player.mats.pirateShip = 0);
      }
      return results;
    },
    playEffect: function(state) {
      ...
      if (choice === 'coins') {
        ...
        attackSuccess = false;
        state.attackOpponents(function(opp) {
          var card, drawn, drawnTreasures, l, len, treasureToTrash;
          drawn = opp.getCardsFromDeck(2);
          state.log("..." + opp.ai + " reveals " + drawn + ".");
          drawnTreasures = [];
          for (l = 0, len = drawn.length; l < len; l++) {
  ...
  makeCard('Rogue', attack, {
    ...
    coins: +2,
    playEffect: function(state) {
      var card, cardToGain, coins, gainables, l, len, my, potions, ref, ref1;
      my = state.current;
      gainables = [];
      ref = state.trash;
      for (l = 0, len = ref.length; l < len; l++) {
      ...
      if (gainables.length > 0) {
        ...
        return state.log("..." + my.ai + " gains " + cardToGain + " from trash.");
      } else {
        return state.attackOpponents(function(opp) {
          var cardToTrash, drawn, drawnTrashables, len1, n, ref2;
          drawn = opp.getCardsFromDeck(2);
          state.log("..." + opp.ai + " reveals " + drawn + ".");
          drawnTrashables = [];
          for (n = 0, len1 = drawn.length; n < len1; n++) {
            card = drawn[n];
            ref2 = card.getCost(state), coins = ref2[0], potions = ref2[1];
            if (coins >= 3 && coins <= 6) {
  ...
  makeCard('Soothsayer', attack, {
    ...
    playEffect: function(state) {
      ...
      return state.attackOpponents(function(opp) {
        ...
        state.gainCard(opp, c.Curse);
        if (state.countInSupply('Curse') < cursesRemaining) {
          return state.drawCards(opp, 1);
        }
      });
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Thief', attack, {
    ...
    playEffect: function(state) {
      return state.attackOpponents(function(opp) {
        var card, cardToGain, drawn, drawnTreasures, l, len, treasureToTrash;
        drawn = opp.getCardsFromDeck(2);
        state.log("..." + opp.ai + " reveals " + drawn + ".");
        drawnTreasures = [];
        for (l = 0, len = drawn.length; l < len; l++) {
  ...
  makeCard('Young Witch', attack, {
    ...
    playEffect: function(state) {
      ...
      return state.attackOpponents(function(opp) {
        if (indexOf.call(opp.hand, bane) >= 0) {
  ...
  makeCard('Advisor', action, {
    ...
    actions: +1,
    playEffect: function(state) {
      var choice, drawn, neighbor, ref;
      drawn = state.current.getCardsFromDeck(3);
      state.log(state.current.ai + " draws " + drawn + ".");
      neighbor = (ref = state.players[1]) != null ? ref : state.players[0];
  ...
  makeCard('Alchemist', action, {
    ...
    cleanupEffect: function(state) {
      var ref, ref1;
      if ((ref = c.Potion, indexOf.call(state.current.inPlay, ref) >= 0) && (ref1 = c.Alchemist, indexOf.call(state.current.inPlay, ref1) >= 0)) {
  ...
  makeCard('Apprentice', action, {
    ...
    actions: +1,
    playEffect: function(state) {
      var coins, potions, ref, toTrash;
      toTrash = state.current.ai.choose('apprenticeTrash', state, state.current.hand);
      if (toTrash != null) {
        ref = toTrash.getCost(state), coins = ref[0], potions = ref[1];
  ...
  makeCard('Baker', action, {
    ...
    startGameEffect: function(state) {
      ...
      for (l = 0, len = ref.length; l < len; l++) {
        player = ref[l];
        results.push(player.coinTokens += 1);
      }
      return results;
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Bandit Camp', c.Village, {
    cost: 5,
    playEffect: function(state) {
      return state.gainCard(state.current, c.Spoils);
    },
    startGameEffect: function(state) {
      return state.specialSupply['Spoils'] = 15;
    },
    ai_playValue: function(state, my) {
      return 821;
    }
  ...
  makeCard('Baron', action, {
    ...
    buys: +1,
    playEffect: function(state) {
      var discardEstate, ref;
      discardEstate = false;
      if (ref = c.Estate, indexOf.call(state.current.hand, ref) >= 0) {
    ...
    ai_playValue: function(state, my) {
      var ref;
      if (ref = c.Estate, indexOf.call(my.hand, ref) >= 0) {
        return 184;
      } else {
  ...
  makeCard('Beggar', action, {
    ...
    reactToAttack: function(state, player, attackEvent) {
      if (player.ai.wantsToDiscardBeggar(state, player)) {
        ...
        return state.gainCard(player, c.Silver, 'draw');
      }
    },
    ai_playValue: function(state, my) {
      return 243;
  ...
  makeCard('Bishop', action, {
    ...
    coins: +1,
    playEffect: function(state) {
      var coins, l, len, opp, potions, ref, ref1, results, toTrash, vp;
      ...
      ref1 = state.players.slice(1);
      results = [];
      for (l = 0, len = ref1.length; l < len; l++) {
        opp = ref1[l];
        results.push(state.allowTrash(opp, 1));
      }
      return results;
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Border Village', c.Village, {
    cost: 6,
    gainEffect: function(state, player) {
      var card, choices, coins, myCoins, myPotions, potions, ref, ref1;
      choices = [];
      ref = c['Border Village'].getCost(state), myCoins = ref[0], myPotions = ref[1];
      for (card in state.supply) {
        if (state.supply[card] > 0) {
          ref1 = c[card].getCost(state), coins = ref1[0], potions = ref1[1];
  ...
  makeCard('Cellar', action, {
    ...
    playEffect: function(state) {
      ...
      state.allowDiscard(state.current, 2e308);
  ...
  makeCard('Conspirator', action, {
    ...
    ai_playValue: function(state, my) {
      var ref;
      if (my.inPlay.length >= 2 || ((ref = my.getCurrentAction()) != null ? ref.isMultiplier : void 0)) {
        return 760;
  ...
  makeCard('Council Room', action, {
    ...
    playEffect: function(state) {
      ...
      for (l = 0, len = ref.length; l < len; l++) {
        opp = ref[l];
        results.push(state.drawCards(opp, 1));
      }
      return results;
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Duchess', action, {
    ...
    coins: +2,
    playEffect: function(state) {
      var discarded, drawn, l, len, pl, ref, results;
      ref = state.players;
      results = [];
      for (l = 0, len = ref.length; l < len; l++) {
        pl = ref[l];
        ...
        if (drawn != null) {
          ...
          if (discarded != null) {
            ...
            results.push(pl.discard.push(drawn));
          } else {
            state.log("...choosing to put it back.");
            results.push(pl.draw.unshift(drawn));
          }
        } else {
          results.push(void 0);
        }
  ...
  makeCard('Embassy', action, {
    ...
    gainEffect: function(state, player) {
      var l, len, pl, ref, results;
      ref = state.players;
      results = [];
      for (l = 0, len = ref.length; l < len; l++) {
        pl = ref[l];
        if (pl !== player) {
          results.push(state.gainCard(pl, c.Silver));
        } else {
          results.push(void 0);
        }
      }
  ...
  makeCard('Explorer', action, {
    ...
    playEffect: function(state) {
      var cardToGain, ref;
      cardToGain = c.Silver;
      if (ref = c.Province, indexOf.call(state.current.hand, ref) >= 0) {
  ...
  makeCard("Feast", action, {
    cost: 4,
    playEffect: function(state) {
      var card, cardName, choices, coins, potions, ref;
  ...
  makeCard('Golem', action, {
    ...
    costPotion: 1,
    playEffect: function(state) {
      var actions, card, drawn, firstAction, l, len, results, secondAction;
      drawn = state.current.dig(state, function(state, card) {
  ...
  makeCard("Grand Market", c.Market, {
    ...
    mayBeBought: function(state) {
      var ref;
      return !(ref = c.Copper, indexOf.call(state.current.inPlay, ref) >= 0);
    },
    ai_playValue: function(state, my) {
      return 795;
    },
  ...
  makeCard('Haggler', action, {
    ...
    buyInPlayEffect: function(state, card1) {
      var card2, cardName, choices, coins1, coins2, potions1, potions2, ref, ref1;
      ref = card1.getCost(state), coins1 = ref[0], potions1 = ref[1];
      choices = [];
      for (cardName in state.supply) {
        card2 = c[cardName];
        ref1 = card2.getCost(state), coins2 = ref1[0], potions2 = ref1[1];
  ...
  makeCard("Herbalist", action, {
    ...
    coins: +1,
    cleanupEffect: function(state) {
      var card, choice, choices, l, len, ref;
      choices = [];
      ref = state.current.inPlay;
      for (l = 0, len = ref.length; l < len; l++) {
        card = ref[l];
  ...
  makeCard("Horse Traders", action, {
    ...
    reactToAttack: function(state, player, attackEvent) {
      var ref;
      if (ref = c['Horse Traders'], indexOf.call(player.hand, ref) >= 0) {
  ...
  makeCard('Hunting Party', action, {
    ...
    playEffect: function(state) {
      ...
      state.revealHand(state.current);
      drawn = state.current.dig(state, function(state, card) {
        return indexOf.call(state.current.hand, card) < 0;
      });
      if (drawn.length > 0) {
        card = drawn[0];
        state.log("..." + state.current.ai + " draws " + card + ".");
  ...
  makeCard('Hunting Grounds', action, {
    ...
    trashEffect: function(state, player) {
      ...
      if (choice === "Estates") {
        ...
        state.gainCard(player, c.Estate);
        return state.gainCard(player, c.Estate);
      } else if (choice === "Duchy") {
        return state.gainCard(player, c.Duchy);
      } else {
  ...
  makeCard('Ironworks', action, {
    cost: 4,
    playEffect: function(state) {
      var card, cardName, choices, coins, count, gained, potions, ref, ref1;
      choices = [];
      ref = state.supply;
      for (cardName in ref) {
        count = ref[cardName];
  ...
  makeCard('Journeyman', action, {
    cost: 5,
    playEffect: function(state) {
      var card, choice, choices, deck, drawn, l, len, my, newcards, unique;
      unique = [];
      ...
      if (drawn.length > 0) {
        ...
        return state.log("..." + state.current.ai + " draws " + newcards + ".");
      }
    },
    ai_playValue: function(state, my) {
      var wantsToJM;
  ...
  makeCard("King's Court", action, {
    ...
    optional: true,
    playEffect: function(state) {
      var card, choices, chosenAction, i, l, md, n, neverPutInDuration, putInDuration, ref, ref1;
      choices = (function() {
        var l, len, ref, results;
        ref = state.current.hand;
        results = [];
      ...
      if (choices.length === 0) {
        ...
        if (chosenAction === null) {
          ...
          for (i = l = 0, ref = this.multiplier; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
            if (chosenAction === null) {
              return;
            }
          ...
          if (!neverPutInDuration) {
            ...
            if (chosenAction.isDuration && chosenAction.name !== 'Tactician') {
              putInDuration = true;
              for (i = n = 0, ref1 = this.multiplier - 1; 0 <= ref1 ? n < ref1 : n > ref1; i = 0 <= ref1 ? ++n : --n) {
  ...
  makeCard("Lookout", action, {
    ...
    ai_playValue: function(state, my) {
      var ref;
      if (state.gainsToEndGame() >= 5 || (ref = state.cardInfo.Curse, indexOf.call(my.draw, ref) >= 0)) {
        return 895;
      } else {
        return -5;
      }
  ...
  makeCard("Mandarin", action, {
    ...
    gainEffect: function(state, player) {
      var card, l, len, order, treasures;
      treasures = (function() {
        var l, len, ref, results;
        ref = player.inPlay;
        results = [];
      ...
      if (treasures.length > 0) {
        for (l = 0, len = treasures.length; l < len; l++) {
          treasure = treasures[l];
  ...
  makeCard("Masquerade", action, {
    ...
    cards: +2,
    playEffect: function(state) {
      var cardToPass, i, l, len, n, nextPlayer, passed, player, ref, ref1;
      passed = [];
      ref = state.players;
      for (l = 0, len = ref.length; l < len; l++) {
        player = ref[l];
      ...
      for (i = n = 0, ref1 = state.nPlayers; 0 <= ref1 ? n < ref1 : n > ref1; i = 0 <= ref1 ? ++n : --n) {
  ...
  makeCard("Merchant Guild", action, {
    ...
    buyInPlayEffect: function(state, card) {
      ...
      return state.log(state.current.ai + " gains 1 Coin Token");
    },
    ai_playValue: function(state, my) {
      return 269;
    }
  ...
  makeCard("Mint", action, {
    ...
    buyEffect: function(state) {
      ...
      results = [];
      for (i = l = ref = inPlay.length - 1; ref <= -1 ? l < -1 : l > -1; i = ref <= -1 ? ++l : --l) {
        if (inPlay[i].isTreasure) {
          state.log("...trashing a " + inPlay[i] + ".");
          state.trash.push(inPlay[i]);
          results.push(inPlay.splice(i, 1));
        } else {
          results.push(void 0);
        }
      }
    ...
    playEffect: function(state) {
      var card, choice, l, len, ref, treasures;
      treasures = [];
      ref = state.current.hand;
      for (l = 0, len = ref.length; l < len; l++) {
        card = ref[l];
  ...
  makeCard('Moneylender', action, {
    ...
    playEffect: function(state) {
      var ref;
      if (ref = c.Copper, indexOf.call(state.current.hand, ref) >= 0) {
  ...
  makeCard('Plaza', c.Village, {
    cost: 4,
    playEffect: function(state) {
      var card, choice, numStartingCards, possibleDiscards;
      numStartingCards = state.current.hand.length;
      possibleDiscards = (function() {
        var l, len, ref, results;
        ref = state.current.hand;
        results = [];
        for (l = 0, len = ref.length; l < len; l++) {
      ...
      if (choice != null) {
        if (indexOf.call(possibleDiscards, choice) >= 0) {
          state.requireDiscard(state.current, 1, function(card) {
            return card === choice;
          });
          state.current.coinTokens += 1;
          state.log(state.current.ai + " discards a " + choice);
          return state.log("... gaining a Coin Token");
        }
      }
    }
  });
  ...
  makeCard('Rats', action, {
    ...
    cards: +1,
    playEffect: function(state) {
      var card, l, len, my, ref, toTrash, trashables;
      my = state.current;
      trashables = [];
      ref = my.hand;
      for (l = 0, len = ref.length; l < len; l++) {
      ...
      if (toTrash != null) {
        return state.doTrash(my, toTrash);
      }
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Rebuild', action, {
    ...
    actions: +1,
    playEffect: function(state) {
      var card, cardToTrash, cardname, choices, coins1, coins2, drawn, l, len, len1, len2, my, n, namedcard, newCard, o, potions1, potions2, ref, ref1, ref2, ref3, ref4, vpChoices;
      my = state.current;
      choices = [];
      ref = ["Estate", "Duchy", "Duke", "Province", "Colony"];
      for (l = 0, len = ref.length; l < len; l++) {
        cardname = ref[l];
        card = c[cardname];
      ...
      for (n = 0, len1 = ref1.length; n < len1; n++) {
        card = ref1[n];
        if (indexOf.call(choices, card) < 0 && card.isVictory) {
          choices.push(card);
        }
      }
      ...
      drawn = my.dig(state, function(state, card) {
        return card.isVictory && card !== namedcard;
      });
      if (drawn !== null && drawn.length > 0) {
        ...
        state.trash.push(drawn[0]);
        vpChoices = [];
        ref2 = ["Estate", "Duchy", "Duke", "Province", "Colony"];
        for (o = 0, len2 = ref2.length; o < len2; o++) {
          cardname = ref2[o];
          card = c[cardname];
          if (state.supply[card] > 0) {
            ref3 = cardToTrash.getCost(state), coins1 = ref3[0], potions1 = ref3[1];
            ref4 = card.getCost(state), coins2 = ref4[0], potions2 = ref4[1];
            if (coins2 <= coins1 + 3) {
              vpChoices.push(card);
            }
          }
        ...
        if (newCard !== null) {
          ...
          return state.log("..." + state.current.ai + " gains " + newCard + ".");
        } else {
          return state.log("..." + state.current.ai + " gains nothing.");
        }
      }
    },
    ai_playValue: function(state, my) {
  ...
  makeCard("Secret Chamber", action, {
    ...
    playEffect: function(state) {
      var discarded;
      discarded = state.allowDiscard(state.current, 2e308);
  ...
  makeCard('Spice Merchant', action, {
    ...
    ai_playValue: function(state, my) {
      var card, ref, trashChoices;
      if (ref = c.Copper, indexOf.call(my.hand, ref) >= 0) {
        return 740;
      } else {
        trashChoices = (function() {
          var l, len, ref1, results;
          ref1 = state.current.hand;
          results = [];
          for (l = 0, len = ref1.length; l < len; l++) {
            card = ref1[l];
            if (card.isTreasure) {
  ...
  makeCard('Squire', action, {
    ...
    trashEffect: function(state, player) {
      var attacks, card, choice, l, len, ref;
      attacks = [];
      ref = state.filledPiles();
      for (l = 0, len = ref.length; l < len; l++) {
        card = ref[l];
      ...
      if (choice) {
        return state.gainCard(player, c[choice]);
      }
    },
    ai_playValue: function(state, my) {
      return 295;
  ...
  makeCard('Tournament', action, {
    ...
    actions: +1,
    startGameEffect: function(state) {
      var l, len, name, prizeNames, prizes;
      prizeNames = ['Bag of Gold', 'Diadem', 'Followers', 'Princess', 'Trusty Steed'];
      prizes = (function() {
        var l, len, results;
        results = [];
        for (l = 0, len = prizeNames.length; l < len; l++) {
          name = prizeNames[l];
          results.push(c[name]);
        }
        return results;
      })();
      for (l = 0, len = prizes.length; l < len; l++) {
        prize = prizes[l];
    ...
    playEffect: function(state) {
      var choice, choices, discardProvince, l, len, opp, opposingProvince, prizes, ref, ref1, ref2;
      opposingProvince = false;
      ref = state.players.slice(1);
      for (l = 0, len = ref.length; l < len; l++) {
        opp = ref[l];
        if (ref1 = c.Province, indexOf.call(opp.hand, ref1) >= 0) {
          state.log(opp.ai + " reveals a Province.");
          opposingProvince = true;
        }
      }
      if (ref2 = c.Province, indexOf.call(state.current.hand, ref2) >= 0) {
        ...
        if (discardProvince) {
          ...
          choices = (function() {
            var len1, n, results;
            results = [];
            for (n = 0, len1 = prizes.length; n < len1; n++) {
              prize = prizes[n];
  ...
  makeCard("Trade Route", action, {
    ...
    globalGainEffect: function(state, player, card, source) {
      ...
      if (card.isVictory && source === 'supply' && indexOf.call(mat, card) < 0) {
  ...
  makeCard("Trader", action, {
    ...
    isReaction: true,
    playEffect: function(state) {
      var coins, i, l, potions, ref, ref1, results, trashed;
      trashed = state.requireTrash(state.current, 1)[0];
      if (trashed != null) {
        ref = trashed.getCost(state), coins = ref[0], potions = ref[1];
        results = [];
        for (i = l = 0, ref1 = coins; 0 <= ref1 ? l < ref1 : l > ref1; i = 0 <= ref1 ? ++l : --l) {
          results.push(state.gainCard(state.current, c.Silver));
        }
        return results;
      }
    },
  ...
  makeCard('Treasure Map', action, {
    cost: 4,
    playEffect: function(state) {
      var l, num, numGolds, ref, ref1, trashedMaps;
      trashedMaps = 0;
      if (ref = c['Treasure Map'], indexOf.call(state.current.inPlay, ref) >= 0) {
        state.log("...trashing the Treasure Map.");
        transferCard(c['Treasure Map'], state.current.inPlay, state.trash);
        trashedMaps += 1;
      }
      if (ref1 = c['Treasure Map'], indexOf.call(state.current.hand, ref1) >= 0) {
  ...
  makeCard('Treasury', c.Market, {
    ...
    cleanupEffect: function(state) {
      var ref;
      if (state.cardState[this].mayReturnTreasury && (ref = c.Treasury, indexOf.call(state.current.inPlay, ref) >= 0)) {
  ...
  makeCard('Tribute', action, {
    cost: 5,
    playEffect: function(state) {
      var card, l, len, len1, n, results, revealedCards, unique;
      revealedCards = state.discardFromDeck(state.players[1], 2);
      unique = [];
      for (l = 0, len = revealedCards.length; l < len; l++) {
        card = revealedCards[l];
        if (indexOf.call(unique, card) < 0) {
          unique.push(card);
        }
      }
      results = [];
      for (n = 0, len1 = unique.length; n < len1; n++) {
        card = unique[n];
        if (card.isAction) {
        ...
        if (card.isVictory) {
          results.push(state.current.drawCards(2));
        } else {
          results.push(void 0);
        }
      }
  ...
  makeCard('Vault', action, {
    ...
    cards: +2,
    playEffect: function(state) {
      var discarded, l, len, opp, ref, results;
      discarded = state.allowDiscard(state.current, 2e308);
  ...
  makeCard('Wishing Well', action, {
    ...
    actions: 1,
    playEffect: function(state) {
      var card, cardName, choices, drawn, l, len, ref, wish;
      choices = [];
      ref = c.allCards;
      for (l = 0, len = ref.length; l < len; l++) {
        cardName = ref[l];
  ...
  transferCard = function(card, fromList, toList) {
    if (indexOf.call(fromList, card) < 0) {
  ...
  applyBenefit = function(state, benefit) {
    ...
    if (benefit.gainSilver) {
      return state.gainCard(state.current, c.Silver);
    }
  };

  upgradeChoices = function(state, cards, filter) {
    var card, card2, cardname2, choices, l, len, used;
    used = [];
    choices = [];
    for (l = 0, len = cards.length; l < len; l++) {
      card = cards[l];
      if (indexOf.call(used, card) < 0) {
        used.push(card);
  ...
  nullUpgradeChoices = function(state, cards, costFunction) {
    var card, cardname, choices, coins, coins2, cost, costStr, costs, l, len, potions, ref, used;
    costs = [];
    for (cardname in state.supply) {
      if (state.supply[cardname] > 0) {
        card = c[cardname];
        cost = "" + card.getCost(state);
        if (indexOf.call(costs, cost) < 0) {
          costs.push(cost);
        }
      }
    }
    ...
    for (l = 0, len = cards.length; l < len; l++) {
      ...
      if (indexOf.call(used, card) < 0) {
        ...
        if (indexOf.call(costs, costStr) < 0) {
  ...
  if (typeof exports !== "undefined" && exports !== null) {
    ref = require('./cards'), c = ref.c, transferCard = ref.transferCard, transferCardToTop = ref.transferCardToTop;
  }
  ...
  PlayerState = (function() {
    ...
    PlayerState.prototype.initialize = function(ai, logFunc) {
      ...
      this.potions = 0;
      this.coinTokens = 0;
      this.coinTokensSpendThisTurn = 0;
    ...
    PlayerState.prototype.getDeck = function() {
      var contents, name, ref1, ref2, result;
      ...
      for (name in ref1) {
        ...
        contents = ref1[name];
        if (contents != null) {
          if (contents.hasOwnProperty('playEffect') || ((ref2 = contents[0]) != null ? ref2.hasOwnProperty('playEffect') : void 0)) {
    ...
    PlayerState.prototype.countCardTypeInDeck = function(type) {
      var card, count, l, len, ref1, typeChecker;
      typeChecker = 'is' + type;
      count = 0;
      ref1 = this.getDeck();
      for (l = 0, len = ref1.length; l < len; l++) {
    ...
    PlayerState.prototype.countPlayableTerminals = function(state) {
      ...
      if (this.actions > 0) {
        return this.actions + (((function() {
          ...
          for (l = 0, len = ref1.length; l < len; l++) {
            card = ref1[l];
            results.push(Math.max(card.getActions(state) - 1, 0));
          }
          return results;
    ...
    PlayerState.prototype.menagerieDraws = function() {
      var card, cardsToDraw, l, len, ref1, seen;
      seen = {};
      cardsToDraw = 3;
      ref1 = this.hand;
      for (l = 0, len = ref1.length; l < len; l++) {
    ...
    PlayerState.prototype.shantyTownDraws = function(hypothetical) {
      var card, cardsToDraw, l, len, ref1, skippedShanty;
    ...
    PlayerState.prototype.copy = function() {
      ...
      other.coinTokensSpendThisTurn = this.coinTokensSpendThisTurn;
      return other;
    };
  ...
  State = (function() {
    ...
    State.prototype.initialize = function(ais, tableau, logFunc) {
      var ai, card, l, len, len1, n, player, playerNum;
      this.logFunc = logFunc;
      this.players = [];
      playerNum = 0;
      for (l = 0, len = ais.length; l < len; l++) {
      ...
      for (n = 0, len1 = tableau.length; n < len1; n++) {
        card = tableau[n];
    ...
    State.prototype.setUpWithOptions = function(ais, options) {
      var ai, card, index, l, len, len1, len2, len3, moreCards, n, o, p, ref1, ref2, ref3, ref4, tableau;
      if (ais.length === 0) {
      ...
      for (n = 0, len1 = ais.length; n < len1; n++) {
        ai = ais[n];
        if (ai.requires != null) {
          ref2 = ai.requires;
          for (o = 0, len2 = ref2.length; o < len2; o++) {
            ...
            } else if (indexOf.call(tableau, card) < 0 && indexOf.call(this.basicSupply, card) < 0 && indexOf.call(this.extraSupply, card) < 0 && !card.isPrize) {
              tableau.push(card);
            }
          }
        }
      ...
      while (tableau.length < 10) {
        ...
        if (!(indexOf.call(tableau, card) >= 0 || indexOf.call(this.basicSupply, card) >= 0 || indexOf.call(this.extraSupply, card) >= 0 || card.isPrize)) {
          tableau.push(card);
        }
        index++;
      }
      ...
      for (p = 0, len3 = tableau.length; p < len3; p++) {
        card = tableau[p];
        if (card.costPotion > 0) {
          if (ref3 = c.Potion, indexOf.call(tableau, ref3) < 0) {
    ...
    State.prototype.filledPiles = function() {
      var key, piles, ref1, value;
      piles = [];
      ref1 = this.supply;
      for (key in ref1) {
    ...
    State.prototype.gameIsOver = function() {
      var emptyPiles, l, len, playerName, ref1, ref2, turns, vp;
      if (this.phase !== 'start') {
        return false;
      }
      emptyPiles = this.emptyPiles();
      if (emptyPiles.length >= this.totalPilesToEndGame() || (this.nPlayers < 5 && emptyPiles.length >= 3) || indexOf.call(emptyPiles, 'Province') >= 0 || indexOf.call(emptyPiles, 'Colony') >= 0 || (indexOf.call(emptyPiles, 'Curse') >= 0 && indexOf.call(emptyPiles, 'Copper') >= 0 && this.current.turnsTaken >= 100)) {
        this.log("Empty piles: " + emptyPiles);
        ref1 = this.getFinalStatus();
        for (l = 0, len = ref1.length; l < len; l++) {
          ref2 = ref1[l], playerName = ref2[0], vp = ref2[1], turns = ref2[2];
    ...
    State.prototype.getFinalStatus = function() {
      var l, len, player, ref1, results;
      ref1 = this.players;
      results = [];
      for (l = 0, len = ref1.length; l < len; l++) {
        player = ref1[l];
        results.push([player.ai.toString(), player.getVP(this), player.turnsTaken]);
      }
      return results;
    };

    State.prototype.getWinners = function() {
      var best, bestScore, l, len, modScore, player, ref1, score, scores, turns;
      scores = this.getFinalStatus();
      best = [];
      bestScore = -2e308;
      for (l = 0, len = scores.length; l < len; l++) {
        ref1 = scores[l], player = ref1[0], score = ref1[1], turns = ref1[2];
    ...
    State.prototype.countInSupply = function(card) {
      var ref1;
      return (ref1 = this.supply[card]) != null ? ref1 : 0;
    };
    ...
    State.prototype.gainsToEndGame = function() {
      var card, count, counts, l, len, minimum, piles, ref1;
    ...
    State.prototype.smugglerChoices = function() {
      var card, choices, coins, l, len, potions, prevPlayer, ref1, ref2;
      choices = [null];
      prevPlayer = this.players[this.nPlayers - 1];
      ref1 = prevPlayer.gainedThisTurn;
      for (l = 0, len = ref1.length; l < len; l++) {
        card = ref1[l];
        ref2 = card.getCost(this), coins = ref2[0], potions = ref2[1];
    ...
    State.prototype.countTotalCards = function() {
      var card, count, l, len, player, ref1, ref2, ref3, total;
      total = 0;
      ref1 = this.players;
      for (l = 0, len = ref1.length; l < len; l++) {
        player = ref1[l];
    ...
    State.prototype.buyCausesToLose = function(player, state, card) {
      var cardInPlay, coinCost, goonses, hypMy, hypState, i, l, len, maxOpponentScore, myScore, n, name, potionCost, ref1, ref2, ref3, ref4, ref5, score, status, turns;
      if ((card == null) || this.supply[card] > 1 || state.gainsToEndGame() > 1) {
        return false;
      }
      maxOpponentScore = -2e308;
      ref1 = this.getFinalStatus();
      for (l = 0, len = ref1.length; l < len; l++) {
        status = ref1[l];
        name = status[0], score = status[1], turns = status[2];
      ...
      if (this.depth === 0) {
        ref2 = state.hypothetical(player.ai), hypState = ref2[0], hypMy = ref2[1];
      } else {
        return false;
      }
      ref3 = card.getCost(this), coinCost = ref3[0], potionCost = ref3[1];
      hypMy.coins -= coinCost;
      hypMy.potions -= potionCost;
      hypMy.buys -= 1;
      hypState.gainCard(hypMy, card, 'discard', true);
      card.onBuy(hypState);
      for (i = n = ref4 = hypMy.inPlay.length - 1; ref4 <= -1 ? n < -1 : n > -1; i = ref4 <= -1 ? ++n : --n) {
      ...
      if ((ref5 = hypMy.ai.toString(), indexOf.call(hypState.getWinners(), ref5) >= 0)) {
        return false;
      }
    ...
    State.prototype.doDurationPhase = function() {
      var card, i, l, len, n, ref1, ref2;
      this.current.gainedThisTurn = [];
      for (i = l = ref1 = this.current.duration.length - 1; ref1 <= -1 ? l < -1 : l > -1; i = ref1 <= -1 ? ++l : --l) {
        card = this.current.duration[i];
        this.log(this.current.ai + " resolves the duration effect of " + card + ".");
        card.onDuration(this);
      }
      ref2 = this.current.multipliedDurations;
    ...
    State.prototype.doActionPhase = function() {
      var card, l, len, ref1, validActions;
      while (this.current.actions > 0) {
        validActions = [null];
        ref1 = this.current.hand;
        for (l = 0, len = ref1.length; l < len; l++) {
          card = ref1[l];
          if (card.isAction && indexOf.call(validActions, card) < 0) {
        ...
        if (indexOf.call(this.current.hand, action) < 0) {
    ...
    State.prototype.doTreasurePhase = function() {
      var card, ctd, l, len, ref1, results, validTreasures;
      while (true) {
        validTreasures = [null];
        ref1 = this.current.hand;
        for (l = 0, len = ref1.length; l < len; l++) {
          card = ref1[l];
          if (card.isTreasure && indexOf.call(validTreasures, card) < 0) {
        ...
        if (indexOf.call(this.current.hand, treasure) < 0) {
      ...
      while ((ctd = this.getCoinTokenDecision()) > 0) {
        this.current.coins += ctd;
        results.push(this.current.coinTokens -= ctd);
      }
      return results;
    };

    State.prototype.getCoinTokenDecision = function() {
      var ct;
      ct = this.current.ai.spendCoinTokens(this, this.current);
      if (ct > this.current.coinTokens) {
        this.log(this.current.ai + " wants to spend more Coin Tokens as it possesses (" + ct + "/" + this.current.coinTokens + ")");
        ct = this.current.coinTokens;
      } else {
        if (ct > 0) {
          this.log(this.current.ai + " spends " + ct + " Coin Token" + (ct > 1 ? "s" : ""));
        }
      }
      this.current.coinTokensSpendThisTurn = ct;
      return ct;
    };
    ...
    State.prototype.getSingleBuyDecision = function() {
      var buyable, card, cardname, checkSuicide, choice, coinCost, count, potionCost, ref1, ref2;
      buyable = [null];
      checkSuicide = this.depth === 0 && this.gainsToEndGame() <= 2;
      ref1 = this.supply;
      for (cardname in ref1) {
        count = ref1[cardname];
        card = c[cardname];
        if (card.mayBeBought(this) && count > 0) {
          ref2 = card.getCost(this), coinCost = ref2[0], potionCost = ref2[1];
      ...
      if (checkSuicide) {
        buyable = (function() {
          var l, len, results;
          results = [];
          for (l = 0, len = buyable.length; l < len; l++) {
            card = buyable[l];
      ...
      this.log("Coin Tokens left: " + this.current.coinTokens);
      choice = this.current.ai.chooseGain(this, buyable);
      return choice;
    };

    State.prototype.doBuyPhase = function() {
      var cardInPlay, choice, coinCost, i, l, potionCost, ref1, ref2;
      while (this.current.buys > 0) {
        ...
        ref1 = choice.getCost(this), coinCost = ref1[0], potionCost = ref1[1];
        this.current.coins -= coinCost;
        this.current.potions -= potionCost;
        this.current.buys -= 1;
        this.gainCard(this.current, choice, 'discard', true);
        choice.onBuy(this);
        for (i = l = ref2 = this.current.inPlay.length - 1; ref2 <= -1 ? l < -1 : l > -1; i = ref2 <= -1 ? ++l : --l) {
    ...
    State.prototype.doCleanupPhase = function() {
      var actionCardsInPlay, card, cardsToCleanup, i, l, len, n, o, ref1, ref2, ref3, ref4, ref5, ref6;
      actionCardsInPlay = 0;
      ref1 = this.current.inPlay;
      for (l = 0, len = ref1.length; l < len; l++) {
        card = ref1[l];
        if (card.isAction) {
          actionCardsInPlay += 1;
      ...
      if (actionCardsInPlay <= 2) {
        while (ref2 = c['Walled Village'], indexOf.call(this.current.inPlay, ref2) >= 0) {
      ...
      this.extraturn = !this.extraturn && (ref3 = c['Outpost'], indexOf.call(this.current.inPlay, ref3) >= 0);
      ...
      for (i = n = ref4 = this.current.multipliedDurations.length - 1; ref4 <= -1 ? n < -1 : n > -1; i = ref4 <= -1 ? ++n : --n) {
      ...
      for (i = o = ref5 = cardsToCleanup.length - 1; ref5 <= -1 ? o < -1 : o > -1; i = ref5 <= -1 ? ++o : --o) {
      ...
      if (!(ref6 = c.Outpost, indexOf.call(this.current.duration, ref6) >= 0)) {
    ...
    State.prototype.gainCard = function(player, card, gainLocation, suppressMessage) {
      var gainSource, i, l, location, reactCard, ref1;
      ...
      if (this.supply[card] > 0 || this.specialSupply[card] > 0) {
        for (i = l = ref1 = player.hand.length - 1; ref1 <= -1 ? l < -1 : l > -1; i = ref1 <= -1 ? ++l : --l) {
    ...
    State.prototype.handleGainCard = function(player, card, gainLocation, gainSource) {
      var cardInPlay, i, l, len, n, o, opp, p, quantity, reactCard, ref1, ref2, ref3, ref4, ref5, ref6, supplyCard;
      if (gainLocation == null) {
        gainLocation = 'discard';
      }
      if (gainSource == null) {
      ...
      ref1 = this.supply;
      for (supplyCard in ref1) {
        if (!hasProp.call(ref1, supplyCard)) continue;
        quantity = ref1[supplyCard];
        c[supplyCard].globalGainEffect(this, player, card, gainSource);
      }
      ref2 = this.specialSupply;
      for (supplyCard in ref2) {
        if (!hasProp.call(ref2, supplyCard)) continue;
        quantity = ref2[supplyCard];
        c[supplyCard].globalGainEffect(this, player, card, gainSource);
      }
      for (i = l = ref3 = player.inPlay.length - 1; ref3 <= -1 ? l < -1 : l > -1; i = ref3 <= -1 ? ++l : --l) {
        cardInPlay = player.inPlay[i];
        cardInPlay.gainInPlayEffect(this, card);
      }
      for (i = n = ref4 = player.hand.length - 1; ref4 <= -1 ? n < -1 : n > -1; i = ref4 <= -1 ? ++n : --n) {
        reactCard = player.hand[i];
        if (reactCard.isReaction) {
          reactCard.reactToGain(this, player, card);
        }
      }
      ref5 = this.players.slice(1);
      for (o = 0, len = ref5.length; o < len; o++) {
        opp = ref5[o];
        for (i = p = ref6 = opp.hand.length - 1; ref6 <= -1 ? p < -1 : p > -1; i = ref6 <= -1 ? ++p : --p) {
    ...
    State.prototype.doDiscard = function(player, card) {
      if (indexOf.call(player.hand, card) < 0) {
    ...
    State.prototype.handleDiscards = function(player, cards) {
      var card, l, len, results;
      results = [];
      for (l = 0, len = cards.length; l < len; l++) {
        card = cards[l];
        if (card.isReaction) {
          results.push(card.reactToDiscard(this, player));
        } else {
          results.push(void 0);
        }
      }
    ...
    State.prototype.allowDiscard = function(player, num, typeFunc) {
      var card, choice, discarded, validDiscards;
      if (typeFunc == null) {
        typeFunc = function(card) {
          return true;
        };
      }
      discarded = [];
      while (discarded.length < num) {
        validDiscards = ((function() {
          var l, len, ref1, results;
          ref1 = player.hand;
          results = [];
          for (l = 0, len = ref1.length; l < len; l++) {
            card = ref1[l];
            if (typeFunc(card != null)) {
              results.push(card);
            }
          }
          return results;
    ...
    State.prototype.requireDiscard = function(player, num, typeFunc) {
      var card, choice, discarded, validDiscards;
      if (typeFunc == null) {
        typeFunc = function(card) {
          return true;
    ...
    State.prototype.attackOpponents = function(effect) {
      var l, len, opp, ref1, results;
      ref1 = this.players.slice(1);
      results = [];
      for (l = 0, len = ref1.length; l < len; l++) {
        opp = ref1[l];
        results.push(this.attackPlayer(opp, effect));
      }
      return results;
    };

    State.prototype.attackPlayer = function(player, effect) {
      var attackEvent, card, l, len, len1, n, reactionCards, ref1;
      attackEvent = {};
      ...
      for (l = 0, len = reactionCards.length; l < len; l++) {
        card = reactionCards[l];
        card.reactToAttack(this, player, attackEvent);
      }
      ref1 = player.duration;
      for (n = 0, len1 = ref1.length; n < len1; n++) {
        card = ref1[n];
    ...
    State.prototype.copy = function() {
      var card, copy, k, key, l, len, newCardState, newPlayers, newSpecialSupply, newState, newSupply, player, playerCopy, ref1, ref2, ref3, ref4, state, v, value;
      newSupply = {};
      ref1 = this.supply;
      for (key in ref1) {
        value = ref1[key];
    ...
    State.prototype.hypothetical = function(ai) {
      var combined, counter, handSize, l, len, my, player, ref1, state;
      state = this.copy();
      counter = 0;
  ...
  modifyCoreTypes = function() {
    var base;
    (base = Array.prototype)._originalToString || (base._originalToString = Array.prototype.toString);
